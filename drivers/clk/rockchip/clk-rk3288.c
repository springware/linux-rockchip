...
PNAME(mux_pll_src_cpll_gll_usb_npll_p)	= { "cpll", "gpll", "usbphy480m_src_blub", "npll" };
...
static struct rockchip_clk_branch rk3288_clk_branches[] __initdata = {
	...
	COMPOSITE_FRACMUX(0, "uart0_frac", "uart0_src", 0,
	...
	COMPOSITE_FRACMUX(0, "uart1_frac", "uart1_src", 0,
	...
	COMPOSITE_FRACMUX(0, "uart3_frac", "uart3_src", 0,
	...
	COMPOSITE_FRACMUX(0, "uart4_frac", "uart4_src", 0,
